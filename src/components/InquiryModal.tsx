...
export const InquiryModal: React.FC<InquiryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-xl flex items-center justify-center p-4 overflow-y-auto animate-in fade-in">
      <div className="relative w-full max-w-2xl glass-panel rounded-3xl border-amber-500/30 p-6 sm:p-10 shadow-2xl bg-[#050d09]/95 my-8">
        
        <button
          onClick={onClose}
          className="absolute top-6 right-6 p-2 rounded-full bg-white/10 text-slate-300 hover:bg-amber-400 hover:text-slate-950 transition-colors"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        {submitted ? (
          <div className="text-center py-12 space-y-4">
            ...
            <p className="text-sm text-slate-300 max-w-md mx-auto font-light">
              Thank you for submitting your commercial requirement. Our procurement lead will reach out to discuss current availability and custom commercial terms.
            </p>
          </div>
        ) : (
          <div>
            <div className="mb-8">
              ...
              <p className="text-xs text-slate-400 font-mono">
                No public pricing. Commercial terms are negotiated privately based on current requirement & destination.
              </p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-4">
              
              <div className="grid grid-cols-3 gap-2 p-1 rounded-xl bg-black/40 border border-white/10 mb-4">
                {[
                  ...
                  <button
                    ...
                    className={`py-2 rounded-lg text-xs font-mono tracking-wider transition-all ${
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g. Apex Fruit Traders Pvt Ltd"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-mono text-slate-300 mb-1">Estimated Quantity Needed</label>
                  <input
                    type="text"
                    placeholder="e.g. 5 Tons / 200 Crates"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Mumbai Mandi / Bangalore"
